...
import static com.example.exportexcell.utils.FileFactory.PATH_TEMPLATE;
...
public class ExcelUtils {
    ...
    private static <T> void insertDataToWorkBook(Workbook workbook, ExportConfig exportConfig, List<T> datas, XSSFCellStyle dataCellStyle){
    ...
    private static <T> void insertDataToCell(T data, Row currentRow, List<CellConfig> cellConfigs, Class clazz, Sheet sheet, XSSFCellStyle dataStyle){
        for (CellConfig cellConfig : cellConfigs){
    ...
    private static Object parseValueByClass(Class clazz, Object cellValue) {
        ...
        switch (clazzName){
            ...
            case "Map":
                ...
                break;
            case "BigDecimal":
                cellValue = parseBibDecimal(cellValue);
                break;
            default:
                break;
        }
    ...
    private static Object parseBibDecimal(Object value) {
        if (ObjectUtils.isEmpty(value)){
            return null;
        }
        try {
